...
<div id="jazzy-collapsible">
    {% for fieldset in forms %}
        <div class="card card-default {{ fieldset.classes }}">
            <div class="card-header collapsible-header" onmouseover="this.style.background='#77B0AA', this.style.color='#003C43'" onmouseout="this.style.background='#E3FEF7'" data-toggle="collapse" data-parent="#jazzy-collapsible" data-target="#{{ fieldset.name|default:general_tab|unicode_slugify }}-tab">
                <h4 class="card-title">
